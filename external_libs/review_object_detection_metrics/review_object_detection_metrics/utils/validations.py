...
import pandas as pd
from review_object_detection_metrics.utils.enumerators import CoordinatesType
from review_object_detection_metrics.utils.general_utils import get_files_recursively
