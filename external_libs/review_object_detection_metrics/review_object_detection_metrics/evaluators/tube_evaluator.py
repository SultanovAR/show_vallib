...
import numpy as np
from review_object_detection_metrics.evaluators.pascal_voc_evaluator import (calculate_ap_11_point_interp,
                                                                             calculate_ap_every_point)
from review_object_detection_metrics.tube import Tube
from review_object_detection_metrics.utils.enumerators import MethodAveragePrecision
from review_object_detection_metrics.utils.read_files import File
...
class TubeEvaluator():
    ...
    def __init__(self,
        ...
        Args:
            ...
            method (MethodAveragePrecision, optional): Recall interpolation method (see review_object_detection_metrics.utils.enumerators). Defaults to MethodAveragePrecision.EVERY_POINT_INTERPOLATION.
        """
